...
plt.figure(0)
plt.plot(PlotAlphaValues, y[0], "-r", label="N = 5")
plt.plot(PlotAlphaValues, y[1], "-g", label="N = 10")
plt.plot(PlotAlphaValues, y[2], "-b", label="N = 20")
...
plt.figure(1)
plt.plot(PlotAlphaValues, y[3], "-r", label="N = 5")
plt.plot(PlotAlphaValues, y[4], "-g", label="N = 10")
plt.plot(PlotAlphaValues, y[5], "-b", label="N = 20")
plt.xlabel("Alpha Values")
plt.ylabel("Ql.s.")
plt.title("Ql.s. of Linearly Separable Functions vs Alpha")
plt.legend(loc="upper right")
